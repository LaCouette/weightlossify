...
interface DistanceModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (distance: number) => Promise<void>;
  isLoading: boolean;
}

export function DistanceModal({ isOpen, onClose, onSubmit, isLoading }: DistanceModalProps) {
      ...
      <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        ...
        >
            ...
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  Enter the total distance covered during your activity.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 sm:flex sm:flex-row-reverse gap-3">
            <button
              type="button"
              onClick={() => distance !== null && onSubmit(distance)}
              disabled={distance === null || isLoading}
